...
Route::prefix('tutoring')->name('tutoring.')->group(function () {
    ...
    Route::name('thank-you.')->group(function () {
        Route::get('thank-you', 'TutoringController@index')->name('index');
    });
    ...
    Route::name('neet-test-series.')->group(function () {
        Route::view('/neet-test-series', 'front.pages.tutoring.neet-test-series.intro')->name('intro');
        Route::view('/neet-test-series-thank-you', 'front.pages.tutoring.neet-test-series.thank-you')->name('thank-you');
    });

    // Cute Program
    Route::name('cute-program.')->group(function () {
        Route::view('/cute-program', 'front.pages.tutoring.cute-program.intro')->name('intro');
        //Route::view('/cute-program/cute-program-thank-you', 'front.pages.tutoring.cute-program.thank-you')->name('thank-you');
        Route::view('/cute-program-thank-you', 'front.pages.tutoring.cute-program.thank-you')->name('thank-you');
    });
