...
Route::prefix('commerce')->name('commerce.')->group(function () {
    ...
    // Cute Program Thank you
    Route::name('thank-you.')->group(function () {
        Route::get('thank-you', 'CommerceController@index')->name('index');
    });
    ...
    // NEET Test Series
    Route::name('neet-test-series.')->group(function () {
        Route::view('/neet-test-series', 'front.pages.commerce.neet-test-series.intro')->name('intro');
        Route::view('/neet-test-series-thank-you', 'front.pages.commerce.neet-test-series.thank-you')->name('thank-you');
    });

    // Cute Program
    Route::name('cute-program.')->group(function () {
        Route::view('/cute-program', 'front.pages.commerce.cute-program.intro')->name('intro');
        //Route::view('/cute-program/cute-program-thank-you', 'front.pages.commerce.cute-program.thank-you')->name('thank-you');
        Route::view('/cute-program-thank-you', 'front.pages.commerce.cute-program.thank-you')->name('thank-you');
    });
