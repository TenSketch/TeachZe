...
Route::prefix('coaching')->name('coaching.')->group(function () {
    ...
    Route::name('thank-you.')->group(function () {
        Route::get('thank-you', 'CoachingController@index')->name('index');
    });
    ...
    Route::name('neet-test-series.')->group(function () {
        Route::view('/neet-test-series', 'front.pages.coaching.neet-test-series.intro')->name('intro');
        Route::view('/neet-test-series-thank-you', 'front.pages.coaching.neet-test-series.thank-you')->name('thank-you');
    });

    // Cute Program
    Route::name('cute-program.')->group(function () {
        Route::view('/cute-program', 'front.pages.coaching.cute-program.intro')->name('intro');
        //Route::view('/cute-program/cute-program-thank-you', 'front.pages.coaching.cute-program.thank-you')->name('thank-you');
        Route::view('/cute-program-thank-you', 'front.pages.coaching.cute-program.thank-you')->name('thank-you');
    });
