<?php $__env->startSection('content'); ?>
    ...
    <div class="position-relative">
        <div class="bg-dark space-2" style="background-image: url('/images/commerce/svg/components/abstract-shapes-20.svg');">
            <div class="container">
                <div class="row">
                    <div class="col-md-7 col-lg-8">
                        ...
                        <p class="text-white-70"><?php echo e($course->excerpt); ?></p>
                   ...
                   &quot;stickyOffsetBottom&quot;: 12
                        ...
                        <div class="position-relative">
                            <div class="w-100 mx-auto">
                                <img class="card-img-top" src="<?php echo e(($course->thumb) ? asset('/storage/'.$course->thumb) : cdn_mix('/images/logos/logo.png')); ?>" alt="Image Description">
                            </div>
                        </div>
                        ...
                        <article class="col-md-6 col-lg-4 mb-5">
                            <div class="card card-bordered h-100">
                                <a class="card-img-top position-relative" href="/course/<?php echo e($otherCourse->slug); ?>">
                                    <img class="card-img-top" src="<?php echo e(($otherCourse->thumb) ? asset('/storage/'.$otherCourse->thumb) : cdn_mix('/images/logos/logo.png')); ?>" alt="<?php echo e($otherCourse->name); ?>">
                                </a>
                                <div class="card-body">
                                    <div class="mb-3">
                                        <h3>
...
<?php echo $__env->make('front.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\TeachZe\resources\views/front/pages/commerce/course.blade.php ENDPATH**/ ?>