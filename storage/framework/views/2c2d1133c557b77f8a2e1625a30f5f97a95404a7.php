...
<head><meta charset="windows-1252">
    ...
    <title><?php echo $__env->yieldContent('title', '21kclass.com'); ?></title>
    ...
    <?php if(request()->routeIs('tutoring.*')): ?>
        <link href="/css/tutoring-theme.min.css" rel="stylesheet">
    <?php elseif(request()->routeIs('commerce.*')): ?>
...
<body>
<?php if(request()->routeIs('tutoring.*')): ?>
    <?php echo $__env->yieldContent('nav-tutoring'); ?>
<?php elseif(request()->routeIs('commerce.*')): ?>
    <?php echo $__env->yieldContent('nav-commerce'); ?>
<?php else: ?>
    <?php echo $__env->yieldContent('nav-coaching'); ?>
<?php endif; ?>
...
<script>
    ...
    var options = {
        ...
        "brandSetting":{
            ...
            "messageText":"Hello, I have a question about <?php echo e(Request::fullurl()); ?>",
...
<?php /**PATH C:\xampp\htdocs\TeachZe\resources\views/front/layouts/app.blade.php ENDPATH**/ ?>