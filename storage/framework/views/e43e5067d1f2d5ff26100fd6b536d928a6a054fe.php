        ...
        <div class="bg-img-hero-center" style="background-image: url('/images/banners/21kgroup-banner.jpeg');background-color: rgba(0, 0, 0, 0.4)">
            <div class="container space-2 space-sm-3 space-md-4 min-vw-100" style="background-color: rgba(0, 0, 0, 0.45);">
                <div class="w-xs-auto text-center">
                    <div class="mb-4">
                        <h2 class="h1 text-white">TeachZe Team</h2>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container space-1">
            <div class="row">
                <div class="col-lg-12 space-top-lg-1 space-bottom-lg-1">
                    <h2 class="h1"><span class="text-dark text-highlight-info">TeachZe Team</span></h2>
                    <p>Change is never easy - unexplored in the beginning, magnificent and groundbreaking at the end. The 21st century has been characterized by constant technological change and disruption like never before. TeachZe Team is on a mission to create online learning spaces for communities that want to explore beyond the conventional. With a trained team that is constantly setting new benchmarks we aim to bring only the best experiences to our students. We have three institutions.</p>
                </div>
            </div>

            <div class="row">
                <div class="col-lg-12 space-top-lg-0 space-bottom-lg-1">
                    <h2 class="h2"><span class="text-dark text-highlight-info">TeachZe School</span></h2>
            ...
            <div class="row">
                <div class="col-lg-12 space-top-lg-0 space-bottom-lg-2">
                    <h2 class="h2"><span class="text-dark text-highlight-info">TeachZe Skills</span></h2>
...
<?php echo $__env->make('front.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\TeachZe\resources\views/front/pages/coaching/about-us/21k-group.blade.php ENDPATH**/ ?>