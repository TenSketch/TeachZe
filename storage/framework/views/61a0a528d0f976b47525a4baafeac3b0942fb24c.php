<?php $__env->startSection('content'); ?>
    ...
    <main id="content" role="main">
        ...
        <div class="container space-top-1 space-top-lg-2 space-bottom-1 space-bottom-lg-2">
            ...
            <div class="w-md-90 w-lg-80 mx-md-auto mb-md-5">
                <h2>Why take NEET Crash Course Pack</h2>
                <ul>
            ...
            <div class="row">
                ...
                <div class="row col-md-10">
                    <div class="col-4 mb-3 mb-md-5">
                        <div class="pr-lg-4">
                            <span class="js-counter h2 text-primary" data-hs-counter-options='{"isCommaSeparated": true}'>4657</span>
                    ...
                    <div class="col-4 mb-3 mb-md-5">
                        <div class="pr-lg-4">
                            <span class="js-counter h2 text-primary" data-hs-counter-options='{"isCommaSeparated": true}'>1879</span>
...
<?php echo $__env->make('front.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\TeachZe\resources\views/front/pages/coaching/academics/neet/crash-course.blade.php ENDPATH**/ ?>