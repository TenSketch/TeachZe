            ...
            <div class="container d-lg-flex align-items-lg-center space-top-2 space-lg-0 min-vh-lg-100">
                ...
                <figure class="col-lg-7 col-xl-6 d-none d-lg-block position-absolute top-0 right-0 pr-0 ie-main-hero" style="margin-top: 6.75rem;">
                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 1137.5 979.2">
                        <path fill="hsla(198, 76%, 52%, 1)" d="M565.5,957.4c81.1-7.4,155.5-49.3,202.4-115.7C840,739.8,857,570,510.7,348.3C-35.5-1.5-4.2,340.3,2.7,389
                            ...
                            <div class="card-body h-100 rounded-lg p-0 p-md-4">
                                <figure class="mb-3">
                                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="36" height="36" viewBox="0 0 8 8">
                                        <path fill="hsla(198, 76%, 52%, 1)" d="M3,1.3C2,1.7,1.2,2.7,1.2,3.6c0,0.2,0,0.4,0.1,0.5c0.2-0.2,0.5-0.3,0.9-0.3c0.8,0,1.5,0.6,1.5,1.5c0,0.9-0.7,1.5-1.5,1.5
                                    ...
                                    <?php $__currentLoopData = $courseCategory->courses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <article class="cbp-item all_course <?php echo e('course_category_' . $i); ?>">
                                            <div class="card card-bordered h-100 m-3">
                                                <a class="card-img-top position-relative" href="/coaching/course/<?php echo e($course->slug); ?>">
                                                ...
                                                <div class="card-body p-3" style="min-height:155px;">
                                                    ...
                                                    <div class="mb-0">
                                                        <h4 class="pgm-card-title">
                                                            <a class="text-inherit" href="/coaching/course/<?php echo e($course->slug); ?>"><?php echo e($course->name); ?></a>
                                                        </h4>
                                                    </div>
                                                ...
                                                <div class="card-footer border-0 p-0 px-3 pb-3">
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        ...
                                                        <a class="btn btn-sm btn-info transition-3d-hover" href="/coaching/course/<?php echo e($course->slug); ?>">Course details</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </article>
...
<?php echo $__env->make('front.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\TeachZe\resources\views/front/pages/coaching/index.blade.php ENDPATH**/ ?>