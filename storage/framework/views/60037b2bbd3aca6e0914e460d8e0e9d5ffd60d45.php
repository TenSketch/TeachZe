<?php $__env->startSection('content'); ?>
    ...
    <main id="content" role="main">
        ...
        <div class="container space-top-1 space-top-lg-2">
            ...
            <div class="container space-top-1 space-bottom-1">
                <div class="w-lg-80 text-center mx-lg-auto mb-5">
                    <h2>TeachZe NEET Coaching</h2>
                </div>
                <p>TeachZe is a pioneer to provide a comprehensive Virtual Class for the NEET aspirants.</p>
                ...
                <p>Hence, we at TeachZe is bringing in the Technology enabled Virtual Class mode to break the geographical barrier for learning and provide expert teaching to the students across Tamil Nadu irrespective of the place they live.</p>
                ...
                <p>We will be providing every student with a Tablet to attend the TeachZe sessions which will be inbuilt with Data Card, Camera and a Head Phone. More so, we will also pay the data charges for the student during the periodicity of the course.</p>
                ...
                <p>At TeachZe, we have designed our Learning Management System (LMS) the foundation on which the entire classes shall happen. This platform will have the multiple features ensuring a better teaching-learning process.</p>
...
<?php echo $__env->make('front.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\TeachZe\resources\views/front/pages/coaching/academics/neet/introduction.blade.php ENDPATH**/ ?>