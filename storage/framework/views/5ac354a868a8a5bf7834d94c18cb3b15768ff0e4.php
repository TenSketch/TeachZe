                        ...
                        <ul class="navbar-nav">
                            ...
                            <li class="hs-has-sub-menu navbar-nav-item">
                                ...
                                <div id="aboutusSubMenu" class="hs-sub-menu dropdown-menu" aria-labelledby="aboutusMegaMenu" style="min-width: 230px;">
                                    ...
                                    <a class="dropdown-item<?php echo e(request()->routeIs('coaching.about-us.21k-group') ?? true ? ' active' : ''); ?>" href="<?php echo e(route('coaching.about-us.21k-group')); ?>">21K Group</a>
                                ...
                                <div id="pagesSubMenu" class="hs-sub-menu dropdown-menu hs-sub-menu-desktop-lg fadeOut animated" aria-labelledby="pagesMegaMenu" style="min-width: 230px; display: none; animation-duration: 300ms;">
                                    <div class="hs-has-sub-menu">
                                        ...
                                        <div id="navSubmenuNeetCoaching" class="hs-sub-menu dropdown-menu hs-sub-menu-desktop-lg fadeOut animated" aria-labelledby="navLinkNeetCoaching" style="min-width: 230px; display: none; animation-duration: 300ms;">
                                            <a class="dropdown-item<?php echo e(request()->routeIs('coaching.academics.neet.introduction') ?? true ? ' active' : ''); ?>" href="<?php echo e(route('coaching.academics.neet.introduction')); ?>">21K NEET Introduction</a>
                                            <a class="dropdown-item<?php echo e(request()->routeIs('coaching.academics.neet.extension-course') ?? true ? ' active' : ''); ?>" href="<?php echo e(route('coaching.academics.neet.extension-course')); ?>">21K NEET Extension Course</a>
                                            <a class="dropdown-item<?php echo e(request()->routeIs('coaching.academics.neet.comprehensive-course') ?? true ? ' active' : ''); ?>" href="<?php echo e(route('coaching.academics.neet.comprehensive-course')); ?>">21K NEET Comprehensive Course</a>
                                            <a class="dropdown-item<?php echo e(request()->routeIs('coaching.academics.neet.crash-course') ?? true ? ' active' : ''); ?>" href="<?php echo e(route('coaching.academics.neet.crash-course')); ?>">21K NEET Crash Course</a>
                                            <a class="dropdown-item<?php echo e(request()->routeIs('coaching.academics.neet.repeater-course') ?? true ? ' active' : ''); ?>" href="<?php echo e(route('coaching.academics.neet.repeater-course')); ?>">21K NEET Repeater Course </a>
                                            <!--<a class="dropdown-item<?php echo e(request()->routeIs('coaching.academics.neet.test-series') ?? true ? ' active' : ''); ?>" href="<?php echo e(route('coaching.academics.neet.test-series')); ?>">21K NEET Test Series</a>-->
                                        </div>
                                    </div>
                                    ...
                                    <div class="hs-has-sub-menu">
                                        ...
                                        <div id="navSubmenuJeeCoaching" class="hs-sub-menu dropdown-menu hs-sub-menu-desktop-lg fadeOut animated" aria-labelledby="navLinkJeeCoaching" style="min-width: 230px; display: none; animation-duration: 300ms;">
                                            <a class="dropdown-item<?php echo e(request()->routeIs('coaching.academics.jee.introduction') ?? true ? ' active' : ''); ?>" href="<?php echo e(route('coaching.academics.jee.introduction')); ?>">21K JEE Coaching</a>
                                            <a class="dropdown-item<?php echo e(request()->routeIs('coaching.academics.jee.extension-course') ?? true ? ' active' : ''); ?>" href="<?php echo e(route('coaching.academics.jee.extension-course')); ?>">21K JEE Extension Course</a>
                                            <a class="dropdown-item<?php echo e(request()->routeIs('coaching.academics.jee.comprehensive-course') ?? true ? ' active' : ''); ?>" href="<?php echo e(route('coaching.academics.jee.comprehensive-course')); ?>">21K JEE Comprehensive Course</a>
                                            <a class="dropdown-item<?php echo e(request()->routeIs('coaching.academics.jee.crash-course') ?? true ? ' active' : ''); ?>" href="<?php echo e(route('coaching.academics.jee.crash-course')); ?>">21K JEE Crash Course</a>
                                            <a class="dropdown-item<?php echo e(request()->routeIs('coaching.academics.jee.test-series') ?? true ? ' active' : ''); ?>" href="<?php echo e(route('coaching.academics.jee.test-series')); ?>">21K JEE Test Series </a>
                                        </div>
                                    </div>
                                    ...
                                    <a class="dropdown-item<?php echo e(request()->routeIs('coaching.academics.competitive-examination') ?? true ? ' active' : ''); ?>" href="<?php echo e(route('coaching.academics.competitive-examination')); ?>">21K Competitive Examination Practice Programs</a>
                                    <a class="dropdown-item<?php echo e(request()->routeIs('coaching.academics.ce-test-series') ?? true ? ' active' : ''); ?>" href="<?php echo e(route('coaching.academics.ce-test-series')); ?>">21K CE Test Series</a>
                                </div>
                            </li>
