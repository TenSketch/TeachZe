            ...
            <div class="container d-lg-flex align-items-lg-center space-top-2 space-lg-0 min-vh-lg-100">
                ...
                <figure class="col-lg-7 col-xl-6 d-none d-lg-block position-absolute top-0 right-0 pr-0 ie-main-hero" style="margin-top: 6.75rem;">
                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 1137.5 979.2">
                        <path fill="hsla(223, 77%, 62%, 1)" d="M565.5,957.4c81.1-7.4,155.5-49.3,202.4-115.7C840,739.8,857,570,510.7,348.3C-35.5-1.5-4.2,340.3,2.7,389
              c0.7,4.7,1.2,9.5,1.7,14.2l29.3,321c14,154.2,150.6,267.8,304.9,253.8L565.5,957.4z"/>
                        ...
                        <g transform="matrix(1 0 0 1 0 0)" clip-path="url(#mainHeroSVG2)">
                            <image width="750" height="750" xlink:href="/images/tutoring/others/img2.jpg" transform="matrix(1.4462 0 0 1.4448 52.8755 0)"></image>
                        </g>
                    </svg>
                </figure>
            </div>
            ...
            <div class="row justify-content-lg-center">
                <div class="col-md-6 col-lg-5 mb-3 mb-md-5 mb-lg-7">
                    <div class="media pr-lg-5" data-aos="fade-up">
                        <figure class="w-100 max-w-8rem mr-4">
                            <img class="img-fluid" src="/images/tutoring/svg/icons/icon-18.svg" alt="SVG">
                        </figure>
                ...
                <div class="col-md-6 col-lg-5 mb-3 mb-md-5 mb-lg-7">
                    <div class="media pl-lg-5" data-aos="fade-up" data-aos-delay="100">
                        <figure class="w-100 max-w-8rem mr-4">
                            <img class="img-fluid" src="/images/tutoring//svg/icons/icon-27.svg" alt="SVG">
                        </figure>
                        <div class="media-body">
                            <h4>tutoring Classes</h4>
                ...
                <div class="col-md-6 col-lg-5 mb-3 mb-md-5 mb-lg-7">
                    <div class="media pr-lg-5" data-aos="fade-up" data-aos-delay="200">
                        <figure class="w-100 max-w-8rem mr-4">
                            <img class="img-fluid" src="/images/tutoring//svg/icons/icon-24.svg" alt="SVG">
                        </figure>
                        <div class="media-body">
                        ...
                        <div class="col-lg-3 d-none d-lg-block">
                            <div class="dzsparallaxer auto-init height-is-based-on-content use-loading mode-scroll bg-light" data-options='{direction: "reverse"}' style="overflow: visible;">
                                <div data-parallaxanimation='[{property: "transform", value:" translate3d(0,0.5rem,0)", initial:"4", mid:"0", final:"-4"}]'>
                                    <img class="img-fluid rounded-lg shadow-lg" src="/images/tutoring/160x160/img39.jpg" alt="Image Description">
                                    <figure class="max-w-15rem w-100 position-absolute bottom-0 left-0 z-index-n1">
                                        <div class="mb-n7 ml-n7">
                                            <img class="img-fluid" src="/images/tutoring/svg/components/dots-5.svg" alt="Image Description">
                                        </div>
                                    </figure>
                                </div>
                            </div>
                            ...
                            <div class="card-body h-100 rounded-lg p-0 p-md-4">
                                <figure class="mb-3">
                                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="36" height="36" viewBox="0 0 8 8">
                                        <path fill="hsla(223, 77%, 62%, 1)" d="M3,1.3C2,1.7,1.2,2.7,1.2,3.6c0,0.2,0,0.4,0.1,0.5c0.2-0.2,0.5-0.3,0.9-0.3c0.8,0,1.5,0.6,1.5,1.5c0,0.9-0.7,1.5-1.5,1.5
                                        ...
                                        <div class="pr-lg-5">
                                            ...
                                            <div class="media">
                                                <div class="avatar avatar-xs avatar-circle d-lg-none mr-2">
                                                    <img class="avatar-img" src="/images/tutoring/160x160/img39.jpg" alt="Image Description">
                                                </div>
                                                <div class="media-body">
        ...
        <div class="container space-2 space-lg-3">
            <div class="row justify-content-lg-between">
                <div class="col-lg-5 order-lg-2 pl-lg-0">
                    <div class="bg-img-hero h-100 min-h-450rem rounded-lg" style="background-image: url('/images/tutoring/others/img3.jpg');"></div>
                </div>
                                    ...
                                    <?php $__currentLoopData = $courseCategory->courses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <article class="cbp-item all_course <?php echo e('course_category_' . $i); ?>">
                                            <div class="card card-bordered h-100 m-3">
                                                <a class="card-img-top position-relative" href="/tutoring/course/<?php echo e($course->slug); ?>">
                                                ...
                                                <div class="card-body p-3" style="min-height:155px;">
                                                    ...
                                                    <div class="mb-0">
                                                        <h4 class="pgm-card-title">
                                                            <a class="text-inherit" href="/tutoring/course/<?php echo e($course->slug); ?>"><?php echo e($course->name); ?></a>
                                                        </h4>
                                                    </div>
                                                ...
                                                <div class="card-footer border-0 p-0 px-3 pb-3">
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        ...
                                                        <a class="btn btn-sm btn-info transition-3d-hover" href="/tutoring/course/<?php echo e($course->slug); ?>">Course details</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </article>
            ...
            <div class="row justify-content-lg-center">
                <div class="col-md-4 mb-7 mb-lg-0">
                        ...
                        <div class="text-center px-md-3 px-lg-7">
                            <figure class="mb-3">
                                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 71.7 64" width="71" height="64">
                                    <path fill="hsla(223, 77%, 62%, 1)" d="M36.8,14.6L42,25.3c0,0.2,0.2,0.2,0.3,0.3L54,27.2c0.3,0,0.5,0.5,0.3,0.8l-8.5,8.2c-0.2,0.2-0.2,0.3-0.2,0.5
                    ...
                    L18,28.1c-0.3-0.3-0.2-0.8,0.3-0.8L30,25.6c0.2,0,0.3-0.2,0.3-0.3l5.3-10.7C36.1,14.2,36.6,14.2,36.8,14.6z"/>
                                    <path opacity=".25" fill="hsla(223, 77%, 62%, 1)" d="M56,5.9l1.5,2.8c0,0,0,0,0.2,0l3.1,0.5c0.2,0,0.2,0.2,0,0.2l-2.3,2.3c0,0,0,0,0,0.2l0.5,3.1
                    ...
                    C55.8,5.7,55.8,5.7,56,5.9z"/>
                                    <path opacity=".25" fill="hsla(223, 77%, 62%, 1)" d="M12.3,0.3l1.3,2.8c0,0,0,0,0.2,0l3,0.5c0.2,0,0.2,0.2,0,0.2l-2.1,2.1c0,0,0,0,0,0.2l0.5,3
                    ...
                    l1.3-2.8C12.1,0.3,12.3,0.3,12.3,0.3z"/>
                                    <path opacity=".25" fill="hsla(223, 77%, 62%, 1)" d="M13.9,49.9l1.5,2.8c0,0,0,0,0.2,0l3.1,0.5c0.2,0,0.2,0.2,0,0.2l-2.3,2.3c0,0,0,0,0,0.2l0.5,3.1
                    ...
                    C13.8,49.8,13.9,49.8,13.9,49.9z"/>
                                    <path opacity=".25" fill="hsla(223, 77%, 62%, 1)" d="M60.8,53.5l1.6,3.1c0,0,0,0,0.2,0l3.5,0.5c0.2,0,0.2,0.2,0,0.3l-2.5,2.5c0,0,0,0,0,0.2l0.7,3.5
                            ...
                            <figure class="mb-3">
                                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 71.7 64" width="71" height="64">
                                    ...
                                    <g transform="matrix(1 0 0 1 0 1.907349e-06)" style="clip-path:url(#SVGID_2_);">
                                        <image width="100" height="100" xlink:href="/images/tutoring/100x100/img10.jpg" transform="matrix(0.36 0 0 0.36 32.8571 25.1429)"></image>
                                    </g>
                                    ...
                                    <g style="clip-path:url(#SVGID_4_);">
                                        <image width="100" height="100" xlink:href="/images/tutoring/100x100/img3.jpg" transform="matrix(0.36 0 0 0.36 16.5714 2.8571)"></image>
                                    </g>
                                    ...
                                    <g style="clip-path:url(#SVGID_6_);">
                                        <image width="100" height="100" xlink:href="/images/tutoring/100x100/img2.jpg" transform="matrix(0.3771 0 0 0.3771 2 24.2857)"></image>
                                    </g>
...
<?php echo $__env->make('front.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\TeachZe\resources\views/front/pages/tutoring/index.blade.php ENDPATH**/ ?>