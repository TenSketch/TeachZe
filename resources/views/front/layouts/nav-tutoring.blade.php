                        ...
                        <ul class="navbar-nav">
                            ...
                            <li class="hs-has-sub-menu navbar-nav-item">
                                ...
                                <div id="faqSubMenu" class="hs-sub-menu dropdown-menu" aria-labelledby="faqMegaMenu" style="min-width: 230px;">
                                    ...
                                    <a class="dropdown-item{{ request()->routeIs('tutoring.faq.who-is-21k-class') ?? true ? ' active' : '' }}" href="{{ route('tutoring.faq.who-is-21k-class') }}">Who is TeachZe for?</a>
...
{{--                            </li>--}}
                            ...
                            <li class="hs-has-sub-menu navbar-nav-item">
                                <a id="connectMegaMenu" class="btn btn-sm btn-primary" href="{{ route('tutoring.neet-test-series.intro') }}">NEET Test Series</a>
                            </li>
                            <li class="hs-has-sub-menu navbar-nav-item">&nbsp;</li>
                            <li class="hs-has-sub-menu navbar-nav-item">
                                <a id="connectMegaMenu" class="btn btn-sm btn-primary" href="{{ route('tutoring.cute-program.intro') }}">Cute Program</a>
                            </li>
                        </ul>
                    </div>
                </div>
