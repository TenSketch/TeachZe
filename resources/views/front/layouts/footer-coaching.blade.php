    ...
    <div class="container">
        <div class="space-top-2 space-bottom-1 space-bottom-lg-2">
            <div class="row justify-content-lg-between">
                <div class="col-lg-3 ml-lg-auto mb-5 mb-lg-0">
                    <div class="mb-4">
                        <a href="{{ route('index') }}" aria-label="Front">
                            <img src="{{asset('/images/logos/TeachZe_logo-footer.png')}}" alt="21kclass.com" width="176">
                        </a>
                    </div>
                ...
                <div class="col-6 col-md-3 col-lg mb-5 mb-lg-0">
                    ...
                    <ul class="nav nav-sm nav-x-0 nav-white flex-column">
                        <li class="nav-item"><a class="nav-link" href="{{ route('coaching.about-us.21k-group') }}">TeachZe Team</a></li>
                        <li class="nav-item"><a class="nav-link" href="{{ route('coaching.about-us.our-team') }}">Team</a></li>
                        <li class="nav-item"><a class="nav-link" href="{{ route('coaching.connect.work-with-us') }}">Careers <span class="badge badge-primary ml-1">We're hiring</span></a></li>
                    </ul>
                </div>
        ...
        <div class="space-1">
            ...
            <div class="w-md-75 text-lg-center mx-lg-auto">
                <p class="text-dark opacity-sm small">TeachZe &copy; {{ date('Y') }}. All rights reserved.</p>
            </div>
        </div>
    </div>
</footer>
