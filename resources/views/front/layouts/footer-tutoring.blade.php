...
">We're hiring</span></a></li>
                ...
                <div class="col-6 col-md-3 col-lg">
                    ...
                    <ul class="nav nav-sm nav-x-0 nav-white flex-column">
                        <li class="nav-item"><a class="nav-link" href="{{ route('tutoring.being21k.student-work') }}">Student Work</a></li>
                        <li class="nav-item"><a class="nav-link" href="{{ route('tutoring.being21k.parents-speak') }}">Parent's Speak</a></li>
                        <li class="nav-item"><a class="nav-link" href="{{ route('tutoring.being21k.meet-our-faculty') }}">Faculties</a></li>
                        <li class="nav-item"><a class="nav-link" href="{{ route('tutoring.being21k.events') }}">Events</a></li>
                        <li class="nav-item"><a class="nav-link" href="{{ route('tutoring.being21k.insights') }}">Insights</a></li>
                    </ul>
                </div>
                ...
                <div class="col-6 col-md-3 col-lg">
                    ...
                    <ul class="nav nav-sm nav-x-0 nav-white flex-column">
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('tutoring.connect.contact-us') }}">
