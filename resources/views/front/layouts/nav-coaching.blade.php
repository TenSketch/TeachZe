                ...
                <div class="ml-auto">
                    <div class="hs-unfold d-sm-none mr-2">
                        ...
                        <div id="jumpToDropdown" class="hs-unfold-content dropdown-menu">
                            <a class="dropdown-item{{ request()->routeIs('coaching.*') ?? true ? ' active' : '' }}" href="{{ route('index') }}">Coaching</a>
                    ...
                    <div class="nav nav-sm nav-y-0 d-none d-sm-flex ml-sm-auto">
                        <a class="nav-link{{ request()->routeIs('coaching.*') ?? true ? ' active' : '' }}" href="{{ route('index') }}">Coaching</a>
                        ...
                        <ul class="navbar-nav">
                            ...
                            <li class="hs-has-sub-menu navbar-nav-item">
                                ...
                                <div id="pagesSubMenu" class="hs-sub-menu dropdown-menu hs-sub-menu-desktop-lg fadeOut animated" aria-labelledby="pagesMegaMenu" style="min-width: 230px; display: none; animation-duration: 300ms;">
                                    ...
                                    <div class="hs-has-sub-menu">
                                        <a id="navLinkFoundationCourse" class="hs-mega-menu-invoker dropdown-item dropdown-item-toggle {{ (request()->routeIs('coaching.academics.foundation-course.*')) ?? true ? 'active' : '' }}" href="javascript:;" aria-haspopup="true" aria-expanded="false" aria-controls="navSubmenuFoundationCourse">TeachZe Foundation Courses</a>
                                        <div id="navSubmenuFoundationCourse" class="hs-sub-menu dropdown-menu hs-sub-menu-desktop-lg fadeOut animated" aria-labelledby="navLinkFoundationCourse" style="min-width: 230px; display: none; animation-duration: 300ms;">
                                            <a class="dropdown-item{{ request()->routeIs('coaching.academics.foundation-course.introduction') ?? true ? ' active' : '' }}" href="{{ route('coaching.academics.foundation-course.introduction') }}">TeachZe Foundation Courses Coaching</a>
                                            <a class="dropdown-item{{ request()->routeIs('coaching.academics.foundation-course.pre-foundation-course') ?? true ? ' active' : '' }}"  href="{{ route('coaching.academics.foundation-course.pre-foundation-course') }}">TeachZe Pre Foundation Course (Class VIII)</a>
                                            <a class="dropdown-item{{ request()->routeIs('coaching.academics.foundation-course.preparatory-foundation-course') ?? true ? ' active' : '' }}"  href="{{ route('coaching.academics.foundation-course.preparatory-foundation-course') }}">TeachZe Preparatory Course (Class IX & X)</a>
                                        </div>
                                    </div>
...
{{--                            </li>--}}
                            ...
                            <li class="hs-has-sub-menu navbar-nav-item">
                                ...
                                <div id="howitworksSubMenu" class="hs-sub-menu dropdown-menu" aria-labelledby="howitworksMegaMenu" style="min-width: 230px;">
                                    ...
                                    <a class="dropdown-item{{ request()->routeIs('coaching.how-it-works.who-is-21k-class') ?? true ? ' active' : '' }}" href="{{ route('coaching.how-it-works.who-is-21k-class') }}">Who is TeachZe for?</a>
...
{{--                            </li>--}}
                            ...
                            <li class="hs-has-sub-menu navbar-nav-item">
                                <a id="connectMegaMenu" class="btn btn-sm btn-primary" href="{{ route('coaching.neet-test-series.intro') }}">NEET Test Series</a>
                            </li>
                            <li class="hs-has-sub-menu navbar-nav-item">&nbsp;</li>
                            <li class="hs-has-sub-menu navbar-nav-item">
                                <a id="connectMegaMenu" class="btn btn-sm btn-primary" href="{{ route('coaching.cute-program.intro') }}">Cute Program</a>
                            </li>
                        </ul>
                    </div>
                </div>
