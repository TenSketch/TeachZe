...
@section('content')
    ...
    <main id="content" role="main">
            ...
            <div class="container space-top-3 space-top-lg-4 space-bottom-md-2 position-relative z-index-2">
                ...
                <div class="row mx-n1 mx-sm-n2">
                    <div class="col-4 align-self-end px-1 px-sm-2 mb-2 mb-sm-3">
                        <div class="ml-md-8">
                            <img class="img-fluid rounded-lg" src="/images/tutoring/900x900/img1.jpg" alt="Image Description">
                        </div>
                    </div>
                    <div class="col-8 px-1 px-sm-2 mb-2 mb-sm-3">
                        <div id="youTubeVideoPlayer" class="video-player d-none d-md-block rounded-lg" style="background-color: #000;">
                            <img class="img-fluid video-player-preview rounded-lg" src="/images/tutoring/900x450/img14.jpg" alt="Image">
                        ...
                        <div class="d-md-none">
                            <img class="img-fluid rounded-lg" src="/images/tutoring/900x450/img14.jpg" alt="Image Description">
                        </div>
                    </div>
                    <div class="col-8 px-1 px-sm-2 mb-2 mb-sm-3">
                        <img class="img-fluid rounded-lg" src="/images/tutoring/900x450/img13.jpg" alt="Image Description">
                    </div>
                    <div class="col-4 px-1 px-sm-2 mb-2 mb-sm-3">
                        <div class="mr-md-8">
                            <img class="img-fluid rounded-lg" src="/images/tutoring/750x750/img2.jpg" alt="Image Description">
                        </div>
                    </div>
                </div>
            </div>

            <div class="position-absolute top-0 right-0 left-0 w-100 h-100 bg-img-hero mt-n11" style="background-image: url('/images/tutoring/svg/components/abstract-shapes-12.svg');"></div>
        ...
        <div class="clearfix mx-3 mx-md-11">
            <img class="img-fluid rounded-lg" src="/images/tutoring/1920x800/img2.jpg" alt="Image Description">
        </div>
        ...
        <div id="openRolesSection" class="container space-2 space-lg-3">
            ...
            <a class="card card-frame py-3 px-4 mb-2" href="{{ route('tutoring.connect.career-intern') }}">
            ...
            <a class="card card-frame py-3 px-4 mb-2" href="{{ route('tutoring.connect.career-software-engineer') }}">
                <div class="row align-items-sm-center">
                  <span class="col-sm-6 text-dark">
                    Software Engineer
                  </span>
