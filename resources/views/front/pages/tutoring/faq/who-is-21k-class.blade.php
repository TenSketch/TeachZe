        ...
        <div class="container space-top-3 space-top-lg-4 space-bottom-2">
            <div class="row align-items-lg-center">
                <div class="col-lg-6 mb-7 mb-lg-0">
                    <div class="mb-4">
                        <h1>TeachZees – For Whom?</h1>
                    </div>
                </div>

                <div class="col-lg-6">
                    <img class="img-fluid" src="/images/tutoring/svg/illustrations/digital-currency-2.svg" alt="Image Description">
                </div>
            </div>
        </div>
            ...
            <div class="w-md-80 w-lg-90 mx-md-auto">
                <div class="media pb-3">
                    ...
                    <div class="media-body">
                        <p class="text-dark mb-0">For those students who do not have access or not wanting to go to physical tutoring centers.</p>
                    </div>
                </div>
                ...
                <div class="media py-3">
                    ...
                    <div class="media-body">
                        <p class="text-dark mb-0">Parents who would like to monitor their child’s progress in the tutoring class on a regular basis.</p>
                    </div>
                </div>
                <div class="media py-3">
                    <span class="icon icon-xs icon-indigo icon-circle mr-3">
