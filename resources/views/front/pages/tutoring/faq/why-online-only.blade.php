        ...
        <div class="container space-top-3 mt-lg-6 space-bottom-2 space-bottom-lg-3">
            <div class="row justify-content-lg-between align-items-lg-center">
                <div class="col-sm-10 col-lg-5 mb-7 mb-lg-0">
                    <img class="img-fluid" src="/images/tutoring/svg/illustrations/reading.svg" alt="Image Description">
                </div>
                ...
                <div class="col-md-6">
                    <div class="mb-5">
                        ...
                        <p class="lead">With our TeachZe, you can learn from the experts at your home and at your pace.</p>
                    </div>
