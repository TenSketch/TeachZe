...
@section('content')
    ...
    <main id="content" role="main">
        ...
        <div class="bg-img-hero-center" style="background-image: url('/images/banners/banner-tai.jpeg');background-color: rgba(0, 0, 0, 0.4)">
