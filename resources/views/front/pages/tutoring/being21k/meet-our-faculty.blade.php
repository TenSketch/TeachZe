            ...
            <div class="">
                <div class="w-lg-75 text-center mx-lg-auto">
                    ...
                    <div class="w-lg-75 mx-lg-auto">
                        <img class="img-fluid" src="/images/tutoring/others/tutoring-faculty.jpg" alt="Image Description">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="position-relative bg-light text-center rounded-lg z-index-2 mx-3 mx-md-11">
                <div class="container space-2">
                    ...
                    <div class="w-md-80 mx-md-auto mb-6">
                        <blockquote class="font-size-2 text-dark">TeachZe intends to replicate the brick and mortar class experience over the internet. This EdTech venture combines the expertise of three enthusiastic domain experts. Santosh Kumar, Dinesh Kumar and Joshi Kumar drive the technology behind 21K.</blockquote>
                    </div>
                </div>
        ...
        <div class="container space-2">
                        ...
                        <div class="card h-100">
                            <div class="card-body">
                                <div class="avatar avatar-xl avatar-circle mb-4">
                                    <img class="avatar-img" src="{{ ($tutor->profile_picture) ? asset('/storage/'.$tutor->profile_picture) : '/images/tutoring/100x100/img12.jpg' }}">
                                </div>
            ...
            <div class="text-center">
                <div class="d-inline-block font-size-1 border bg-white text-center rounded-pill py-3 px-4">
                    Wanna join our faculty team? <a class="font-weight-bold ml-3" href="{{ route('tutoring.connect.work-with-us') }}">We are hiring <span class="fas fa-angle-right fa-sm ml-1"></span></a>
                </div>
            </div>
        </div>
