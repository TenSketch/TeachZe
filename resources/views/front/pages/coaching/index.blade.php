                                    ...
                                    @foreach($courseCategory->courses as $course)
                                        <article class="cbp-item all_course {{ 'course_category_' . $i }}">
                                            <div class="card card-bordered h-100 m-3">
                                                <a class="card-img-top position-relative" href="/coaching/course/{{ $course->slug }}">
                                                ...
                                                <div class="card-body p-3" style="min-height:155px;">
                                                    ...
                                                    <div class="mb-0">
                                                        <h4 class="pgm-card-title">
                                                            <a class="text-inherit" href="/coaching/course/{{ $course->slug }}">{{ $course->name }}</a>
                                                        </h4>
                                                    </div>
                                                ...
                                                <div class="card-footer border-0 p-0 px-3 pb-3">
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        ...
                                                        <a class="btn btn-sm btn-info transition-3d-hover" href="/coaching/course/{{ $course->slug }}">Course details</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </article>
