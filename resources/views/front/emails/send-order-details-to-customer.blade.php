...
<section class="container" style="font-size:13px;">
    <div class="row">
        <div class="col-md-12" style="width:100%;margin: 0 auto">
            ...
            <p>
                Thank you for the recent payment you have made to us. Your order has been successfully placed.
            </p>
            <p>
            ...
            <div style="margin-top:0px">
                <p>
                    <b>Thank you for shopping with 21kclass.com</b>
                </p>
                <p style="margin-top:5px;font-size:12px;color:#212121;">
                    Got Questions? Please get in touch with our <a href="mailto:hello@21kclass.com" style="color:#2175ff">24x7 Customer Care</a>
                </p>
            </div>
        </div>
    </div>
